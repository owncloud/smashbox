...
ext_storage_mount_list = config.get('ext_storage_mount_list', "")
...
def sharer(step):
    ...
    list_files(d)
    print "remote_dir is %s" % remote_dir
    run_ocsync(d, remote_folder=remote_dir, user_num=1)
    list_files(d)
...
def shareeOne(step):
    ...
    run_ocsync(d, remote_folder=remote_dir, user_num=2)
    list_files(d)
...
def shareeTwo(step):
    ...
    run_ocsync(d, remote_folder=remote_dir, user_num=3)
    list_files(d)
